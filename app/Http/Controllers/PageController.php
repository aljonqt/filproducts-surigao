...
/* ================= PAGE 4 : CONTRACT PAGE 1 ================= */
        ...
        by and between SURIGAO CABLE TELEVISION INC., a corporation duly organized and existing under and 
        by virtue of Philippine laws with principal office at G/F, Diegas Bldg, Borromeo St, Surigao, Surigao del Norte, Philippines, hereinafter referred to as FPSTI:
        ...
        21. Any action arising from this CONTRACT shall be filed in the appropriate Trial Court in Surigao City to the exclusion of any court. The aggrieved 
        ...
        All unpaid dues, arrears and monthly subscriptions for the period shall be settled by the latter prior to the effectivity of the termination.
            ...
            IN WITNESS THEREOF, the parties hereto have hereunto signed this contract the day of year first above-written at G/F, Diegas Bldg, Borromeo St, Surigao, Surigao del Norte, Philippines.
            ",
                0,
                'J',
                false
            ...
            $pdf->Cell(0,5,'CITY OF SURIGAO           ) SS',0,1);
            $pdf->Cell(0,5,'PROVINCE OF SURIGAO DEL NORTE         )',0,1);
            ...
            /* INTRO */
            $pdf->MultiCell(0,5,"
            BEFORE ME, personally appeared this _________ in _________, Surigao City, Philippines, the following with their evidence of identity written opposite their name below:
            ");
...
/* ================= PAGE 4 : CONTRACT PAGE 1 ================= */
            ...
            This CONTRACT SUBSCRIPTION is made and entered into this day of {$day} of {$month}, {$year}
            by and between SURIGAO CABLE TELEVISION INC., a corporation duly organized and existing under and by virtue of Philippine laws with principal office at G/F, Diegas Bldg, Borromeo St, Surigao, Surigao del Norte, Philippines, hereinafter referred to as FPSTI:
            ...
            21. Any action arising from this CONTRACT shall be filed in the appropriate Trial Court in Surigao City to the exclusion of any court. The aggrieved party shall be entitled to attorney’s fees and collection expenses equivalent to 25% of the total amount due which in no case shall be less than Php 3,000.00.
